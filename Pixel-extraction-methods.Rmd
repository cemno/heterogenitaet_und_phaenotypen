---
title: "Different approaches for pixel extraction"
...
#### vielleicht ein paar bilder {.active .tabset .tabset-fade .tabset-pills}


...
Introduction into the Results - what is done where.
creation of RProj folder. same folder structure. 


#### Input Data 

Dataframe summaries - conversion from input data to workable data 
...
### Code  {.active .tabset .tabset-fade .tabset-pills}

Introduction into the Results - what is done where.

#### Preparations  {.active .tabset .tabset-fade .tabset-pills}

##### Required libraries {.active}
...
If you are lucky and have a powerful machine to work with, you can set the 
amount of threads here. 

WARNING: If you do create a cluster, it is highly advised to close it again.
WARNING: This is done at the end of the "Data Wrangling" chapter. 

More information on that (here <- hyperlink)
...
Loading the raster image and the shapefiles into R. 
...
##### Pixel count {.tabset .tabset-fade .tabset-pills}

Check extracted pixel count per Plot
...
Spectra normalized against Flox data
...
##### Principal Conponent Analysis (PCA) {.tabset .tabset-fade .tabset-pills}
...
ggplot(distance_comparision, aes(x = approach, y = distance, fill = approach, group = approach))+
  ...
  ylab("coordinate distance")+
  xlab("extraction method")+
  ggtitle("Distance between coordinates of FloX and each measurement")+
  facet_wrap(vars(resolution), ncol = 4, labeller = labeller(resolution = resolution.labs))+
...
Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich 
Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich 
Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich 
Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich 
Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich Julie-Jülich 

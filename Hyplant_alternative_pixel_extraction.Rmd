...
knitr::kable(column_to_rownames(tibble(names = c("minimalistic", "normal"), 
                                ...
                                var = "names"), 
             format = "pipe", digits = 2, align = 'c', caption = "Correlation of determination between the minimalistic and the normal approch at different overflights (and heights)")

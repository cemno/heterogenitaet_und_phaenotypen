...
t.test(distance_minimalistic_1229, distance_normal_1229, alternative = "two.sided", conf.level = 0.95, paired = TRUE)
print("Comparison between extraction methods at high resolution:")
t.test(distance_minimalistic_1242, distance_normal_1242, alternative = "two.sided", conf.level = 0.95, paired = TRUE)
print("Comparison between low and high resolution with minimalistic extraction method:")
t.test(distance_minimalistic_1229, distance_minimalistic_1242, alternative = "two.sided", conf.level = 0.95, paired = TRUE)
print("Comparison between low and high resolution with normal extraction method")
t.test(distance_normal_1229, distance_normal_1242, alternative = "two.sided", conf.level = 0.95, paired = TRUE)

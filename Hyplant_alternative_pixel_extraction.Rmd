...
pca_1229_minimalistic <- prcomp(select(as.long.df(spc_1229_minimalistic), !c("PLOTID")), scale = TRUE)
...
pca_1229_minimalistic
as.long.df(spc_1229_minimalistic)
#fviz_eig(pca_1229_minimalistic)
par(mar = c(4,6,1,0)+.1, mfrow = c(2,2), oma = c(1,1,4,1), yaxs = "r")
fviz_pca_var(pca_flox,
...
fviz_pca(pca_1229_minimalistic,
             col.ind = "cos2", # Colour by the quality of representation
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),

...
bands_mean_minimalistic_1229 <- mutate(normal_1229, across(starts_with("Georef"), ~ .x / 1000))
bands_mean_minimalistic_1229 <- summarise(group_by(bands_mean_minimalistic_1229, PLOTID), across(starts_with("Georef"), mean))
bands_mean_minimalistic_1242 <- mutate(normal_1242, across(starts_with("Georef"), ~ .x / 1000))
bands_mean_minimalistic_1242 <- summarise(group_by(minimalistic_1242, PLOTID), across(starts_with("Georef"), mean))
...
FloX_band_760 <- data.frame(select(FloX_mean, PLOTID = Plot),
                                   FloX = rowMeans(select(FloX_mean, band_760_FloX)))
...
# Computing mean of bands around 760 nm (+- 0.5)
minimalistic_1229_band_760 <- data.frame(select(minimalistic_1229_mean, general_columns), 
                                         band_760 = rowMeans(select(minimalistic_1229_mean, band_760_1229)))
minimalistic_1242_band_760 <- data.frame(select(minimalistic_1242_mean, general_columns), 
                                         band_760 = rowMeans(select(minimalistic_1242_mean, band_760_1242)))
normal_1229_band_760 <- data.frame(select(normal_1229_mean, general_columns),
                                   band_760 = rowMeans(select(normal_1229_mean, band_760_1229)))
normal_1242_band_760 <- data.frame(select(normal_1242_mean, general_columns),
                                   band_760 = rowMeans(select(normal_1242_mean, band_760_1242)))
```
...
cor(comparison_1229_760$FloX, comparison_1229_760$minimalistic, method = "spearman")
cor(comparison_1229_760$FloX, comparison_1229_760$normal, method = "spearman")

# Correlation for 1242 o'clock
cor(comparison_1242_760$FloX, comparison_1242_760$minimalistic, method = "spearman")
cor(comparison_1242_760$FloX, comparison_1242_760$normal, method = "spearman")


ggplot(comparison_1229_760, aes(x = FloX))+

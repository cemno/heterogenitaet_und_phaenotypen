...
fviz_eig(pca_1229, title = "PCA: low Resolution")
...
fviz_eig(pca_1242, title = "PCA: high Resolution")
...
fviz_eig(pca_all, title = "PCA: high Resolution")
...
fviz_pca_ind(pca_all)
summary(Coor)
Coor <- rownames_to_column(Coor, "plot")

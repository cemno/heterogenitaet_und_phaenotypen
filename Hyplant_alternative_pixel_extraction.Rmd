...
```{r, fig.cap = "Comparison of the minimalistic and normal extraction methods by using the score distance from FloX to each of the methods of the first two principal components. Separated between the low and high resolution data set. Paired one-sided students t-test, n = 15, p.value: * < 0.05, ** < 0.01, *** < 0.001 ."}
if(buffer == TRUE){
  boxplot_comparison_approach <- boxplot_comparison_approach + ggtitle("Score distance between FloX and each approach\nusing the buffered shapefiles")
  boxplot_comparison_resolution <- boxplot_comparison_resolution + ggtitle("Score distance between FloX and each resolution\nusing the buffered shapefiles")
  ggsave(plot = boxplot_comparison_approach, filename = "images/boxplot_comparison_approach_buffered.png")
  ggsave(plot = boxplot_comparison_resolution, filename = "images/boxplot_comparison_resolution_buffered.png")
}else{
  boxplot_comparison_approach <- boxplot_comparison_approach + ggtitle("Score distance between FloX and each approach")
  boxplot_comparison_resolution <- boxplot_comparison_resolution + ggtitle("Score distance between FloX and each resolution")
  ggsave(plot = boxplot_comparison_approach, filename = "images/boxplot_comparison_approach.png")
  ggsave(plot = boxplot_comparison_resolution, filename = "images/boxplot_comparison_resolution.png")
}

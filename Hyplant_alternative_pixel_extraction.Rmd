...
```
##### Overflight 12:29 {.active}
```{r echo = FALSE, results = "asis"}
# Create table for plotting
knitr::kable(comparison_1229_760, format = "html", align = 'c', caption = "Overflight at 12:29 o'clock, Band 760")
```
##### Overflight 12:42
```{r echo = FALSE, results = "asis"}
knitr::kable(comparison_1242_760, format = "html", align = 'c', caption = "Overflight at 12:42 o'clock, Band 760")
```

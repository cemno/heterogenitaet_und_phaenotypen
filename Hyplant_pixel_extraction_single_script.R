...
# Radiance Raster
radiance_1229_600 <- brick("data/rasterfiles/20180629-CKA-1229-600-L3-N-DUAL_radiance_img_surfrad-rect_subset.TIF")
radiance_1242_350 <- brick("data/rasterfiles/20180629-CKA-1242-350-L2-E-DUAL_radiance_img_surfrad-rect_subset.TIF")

# Plots & Attributes
buffer = FALSE
plots_1229 <- st_read("data/shapefiles/Barley_1229.shp")
plots_1242 <- st_read("data/shapefiles/Barley_1242.shp")
...
# Creating a buffer, uncomment this section on the second run
#buffer <- TRUE
...
# Writing shapefiles to disk (if needed)
#write_sf(plots_1229, "data/shapefiles/Barley_1229_buffered_30_cm.shp")
#write_sf(plots_1242, "data/shapefiles/Barley_1242_buffered_30_cm.shp")
...
#### FloX data
# Import FloX data
FloX <- read.csv("data/FloX_FULL_Reflected_Radiance_180629_converted.csv", header = TRUE, check.names = FALSE)
